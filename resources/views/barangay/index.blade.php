<x-app-layout>
    ...
    <div class="bg-olive-green w-[1400px] h-[813px] ml-8 mt-16 px-5 py-5 rounded-[48px] flex flex-row">
        ...
        <p class="text-dirty-white font-robotocondensed ml-3 font-bold text-[48px] absolute text-start">BARANGAY</p>
        <!--Search-->
        ...
        <div class="bg-dirty-white w-[1400px] h-max absolute mt-20 -ml-5 border shadow-inner">
            ...
            <div class="bg-green w-[1400px] h-[48px] absolute flex flex-row border border-white shadow-lg">
                    ...
                    <p class="font-robotocondensed text-dirty-white text-[18px] font-bold px-max py-2 ml-44">BARANGAY NAME</p>
                    <p class="font-robotocondensed text-dirty-white text-[18px] font-bold px-max py-2 ml-60">MUNICIPALITY</p>
                    <p class="font-robotocondensed text-dirty-white text-[18px] font-bold px-max py-2 ml-52">ZIP CODE</p>
                ...
                @forelse ($barangays as $barangay)
                     <tr class="border shadow-md">
                        ...
                        <td class="px-6 py-4 w-[205px]">
                            <a href="{{ route('barangay.show', $barangay->id) }}" class="text-deep-green hover:text-green"><i class="fa-solid fa-eye"></i></a>
                        </td>

                        @empty
                        <td class="px-6 py-4 font-robotocondensed text-deep-green text-[16px] font-bold">
                            We can't find a barangay with that name
                        </td>
                    </tr>
                @endforelse
