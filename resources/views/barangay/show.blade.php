    ...
    <div class="pt-10 pb-14">
        ...
        <div class="">
                <div class="">
                    ...
                    <a href="{{ route('barangay.edit', $barangay->id) }}" class="button h-8 w-max text-center mt-6 ml-[200px] bg-deep-green px-3 text-dirty-white border-dirty-white border-2 font-semibold">Edit Barangay</a>
