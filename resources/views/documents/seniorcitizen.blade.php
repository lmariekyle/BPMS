<h2 style="font-family: 'Roboto', sans-serif; font-size: 18px; font-weight: 800; text-align: center; letter-spacing: 0.1em;">Barangay Certification</h2>
    ...
    <div style="margin-top:32px; width:750px;">
      <p style="font-family: 'Lora', serif; font-size: 14px; text-align: start; margin-left: 44px; margin-right: 44px; text-indent: 22px; font-weight:400">This is to certify that <span style="text-decoration: underline;">{{$requestee->requesteeFName}} {{$requestee->requesteeMName}} {{$requestee->requesteeLName}}</span>, is a bonafide resident of Barangay Poblacion, Dalaguete, Cebu. He/She is <span style="text-decoration: underline;">60</span> years old and was born on <span style="text-decoration: underline;">October 23, 1964</span></p>
    </div>
