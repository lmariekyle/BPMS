...
<body class="bg-dirty-white">
    ...
    <div class="flex flex-col justify-center place-items-center ml-[400px] mt-[100px] w-max h-max">
        ...
        <p class="font-robotocondensed  text-[18px] text-deep-green px-4  text-center indent-4 break-normal w-max h-max">PLEASE DO CHECK YOUR NOTIFICATIONS FOUND IN YOUR PROFILE PAGE</p>
